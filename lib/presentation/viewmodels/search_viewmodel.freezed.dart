...
mixin _$SearchState {
  ...
  List<Assignment> get results => throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String query, List<Assignment> results});
}
...
class _$SearchStateCopyWithImpl<$Res, $Val extends SearchState>
  ...
  @override
  $Res call({Object? query = null, Object? results = null}) {
    return _then(
      _value.copyWith(
            query: null == query
                ? _value.query
...
class _$SearchStateImpl implements _SearchState {
  const _$SearchStateImpl({
    this.query = '',
    final List<Assignment> results = const [],
  }) : _results = results;

  @override
  @JsonKey()
  final String query;
  final List<Assignment> _results;
  @override
  @JsonKey()
  List<Assignment> get results {
